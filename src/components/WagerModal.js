  ...
  function buildRadioGroup() {
    if (wagerType === "ou") {
      return (
        ...
        >
          <FormControlLabel
            value={"o@" + props.overUnder}
            control={<Radio color="primary" />}
            label={"Over " + props.overUnder}
          />
          <FormControlLabel
            value={"u@" + props.overUnder}
            control={<Radio color="primary" />}
            label={"Under " + props.overUnder}
          />
        </RadioGroup>
      );
      ...
      return (
        <RadioGroup
          ...
          onChange={(val) => {
            setSelection(val.target.value);
            var boostSelected = () => {
              var selectedTeam = props.teams.filter(
                (t) => t.abbreviation === val.target.value.split("@")[0]
              );
        ...
        >
          <FormControlLabel
            value={props.teams[0].abbreviation + "@" + props.line.spread}
            control={<Radio color="primary" />}
            label={props.teams[0].abbreviation + "@" + props.line.spread}
          />
          <FormControlLabel
            value={props.teams[1].abbreviation + "@" + -props.line.spread}
            control={<Radio color="primary" />}
            label={props.teams[1].abbreviation + "@" + -props.line.spread}
          />
        </RadioGroup>
      );
    } else {
      return (
        ...
        >
          <FormControlLabel
            value={
              props.teams[0].abbreviation +
              "@" +
              props.line.homeTeamOdds.moneyLine
            }
            control={<Radio color="primary" />}
            label={
              props.teams[0].abbreviation +
          ...
          <FormControlLabel
            value={
              props.teams[1].abbreviation +
              "@" +
              props.line.awayTeamOdds.moneyLine
            }
            control={<Radio color="primary" />}
            label={
              props.teams[1].abbreviation +
